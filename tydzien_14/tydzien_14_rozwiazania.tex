...
Przyjmij, że suche powietrze składa się z następującej mieszaniny gazów: 
$N_2$ (78\%), $O_2$ (22\%). Rozważ powietrze w warunkach normalnych:
$T$ = 300\,K, $p$ = 101325~Pa. Oblicz:
\begin{enumerate}[a)]
      \item ciśnienia parcjalne tlenu i azotu: $p_{O_2}$, $p_{N_2}$,
      \item objętość jednego mola powietrza: $V$
\end{enumerate}      

\vspace{1cm}

\begin{wrapfigure}[13]{r}{0.2\linewidth}\hspace{5mm}
      \href{https://pl.wikipedia.org/wiki/Wykres_fazowy#/media/Plik:Phase_diagram_of_water.svg}{
      \resizebox{1\linewidth}{!}{\includegraphics{diagram_fazowy_wody_qr_code.png}}
      }
\end{wrapfigure}
Następnie oblicz wkład do ciśnienia powietrza od pary wodnej 
w następujących sytuacjach:
\begin{enumerate}[a)]
      \item powietrze wydychane zimą z ust człowieka po wyrównaniu temperatury
            z otoczeniem. Temperatura otoczenia: -20$^\circ$C
      \item powietrze w mieszkaniu: wilgotność względna 50\% w temperatura 20$^\circ$C.       
\end{enumerate}
\vspace{0.2cm}
Przyjmij, że wszystkie gazy są doskonałe.
Stała gazowa wynosi $R = 8.31\,$J/(mol$\cdot$K)
Brakujące dane odczytać z diagramu fazowego wody, podanego pod linkiem QR.

\vspace{0.2cm}
\textbf{Rozwiązanie:} 

\resizebox{1\linewidth}{!}{\includegraphics{zad_4_str1.png}}
\resizebox{1\linewidth}{!}{\includegraphics{zad_4_str2.png}}
\resizebox{1\linewidth}{!}{\includegraphics{zad_4_str3.png}}
