...
{\it Uwaga:} W punkcie krytycznym równanie stanu $f(p,v,T)=0$ ma pierwiastek potrójny oraz występuje punkt przegięcia izotermy.

\pagebreak
\zaddom
Znając dla gazu doskonałego $\gamma = \frac{1}{T}$, $\beta = \frac{1}{T}$, $\kappa=\frac{1}{p}$, odtwórz r. stanu.
