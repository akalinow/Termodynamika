...
\zadanie
Okręt podwodny o stalowym kadłubie i masie m = $1000 \, \textrm{t}$ jest zanurzony na głębokości peryskopowej tak, że siła wyporu jest dokładnie równa ciężarowi okrętu (pływalność zerowa). Temperatura wody wynosi przy tym 10\degree C. O ile trzeba zmienić balast okrętu, żeby utrzymać zerową pływalność po wpłynięciu na wodę o temperaturze 20\degree C? Współczynnik rozszerzalności objętościowej wody w tym zakresie temperatur wynosi $\gamma_w = 1.5 \cdot 10^{-4} K^{-1}$, zaś współczynnik rozszerzalności liniowej stali $\alpha_s = 1.2 \cdot 10^{-5} K^{-1}$. Ściśliwość wody i stali można zaniedbać.

\vspace{2mm}{\bf Rozwiązanie}:

Na okręt działają dwie przeciwnie skierowane siły, siła wyporu $F_w = \rho_w g V$ i siła ciężkości $F_g = mg$. Pływalność zerowa oznacza równowagę tych dwóch sił: $F_w = F_g$ co pozwala nam wyznaczyć objętość okrętu:
\[
V = \frac{m}{\rho_w}
\]
...
\[
m'-m=m (3\alpha_s-\gamma_w) \Delta T = -1.14\,\textrm{ton}
\]
...
Wiem, że $V_1 = m\,V_2$ gdzie $V = V_1 + V_2$. Z równania stanu gazu dla dolnego i górnego zbiornika w tej samej temperaturze dostajemy:
\[
...
\]
Otrzymujemy równanie kwadratowe na $m'$:
\[
m'^2 - \alpha m' - 1 = 0
\]
którego rozwiązaniem z $m' > 0$ jest:
\[
...
Jakie powinno być ciśnienie $p_0$ nad powierzchnią wody, aby nurek zatonął? Powietrze traktujemy jako gaz doskonały, jego masę zaniedbujemy. Grubość ścianek naczynia zaniedbujemy. Temperatura wody jest równa temperaturze otoczenia, a jej gęstość w tej temperaturze jest znana i wynosi $\rho_{w}$.\\\\\\\\
...
\begin{equation}
M=r_w\times F_w+r_c\times Q=(r_w-r_c)\times F_w=e_z mg \,b\sin\alpha \left(\frac{\rho_wa^2}{12\rho_bb^2}(1+\frac{1}{2}\tan^2\alpha)-\frac{1}{2}(1-\frac{\rho_b}{\rho_w})\right)
\end{equation}
