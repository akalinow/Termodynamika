...
\\[2mm]
%\small{\em WskazÃ³wka: Zadanie to moÅ¼na sprowadziÄ do kombinatorycznego problemu rozmieszczania kul w pudeÅkach. CzÄ%stki klasyczne naleÅ¼y traktowaÄ jako rozrÃ³Å¼nialne, natomiast kwantowe jako nierozrÃ³Å¼nialne. Poza tym naleÅ¼y wziÄ%Ä pod uwagÄ, Å¼e zgodnie z zasadÄ% Pauliego Å¼adne 2 czÄ%stki kwantowe (nierozrÃ³Å¼nialne) o spinie poÅÃ³wkowym nie mogÄ% znajdowaÄ siÄ w tym samym stanie jednoczÄ%stkowym.}\\
%{\em (Zad. 4.4 â A.\,Fronczak, ``Zadania i problemy z rozwiÄ zaniami z termodynamiki i 
%	fizyki statystycznejââ, Oficyna Wydawnicza Politechniki Warszawskiej, 2006).}
...
Stosując model nieoddziałujących oscylatorów oraz zakładając że energia obu podukładów jest duża ($q_i \gg N$), pokazać, że:
\begin{enumerate}[a)]
...
\end{enumerate}
{\it Odpowiedź:  a) $\Omega_A=1$, $\Omega_B=6$, ~~ b) $\Omega=19$, ~~ c)   $0$, ~~ d) $S=k\log\Omega$.}
...
{\it Odpowiedź: Liczba kombinacji bez powtórzeń   $\left( \begin{tabular}{c}  N \\ $n$\end{tabular} \right)^2$.}
