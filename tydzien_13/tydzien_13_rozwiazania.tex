...
$$
zatem zgodnie z rozkładem Boltzmana gęstość prawdopodobieństwa rozkładu prędkości cząstki zadana jest przez:
$$
...
$$
\frac{1}{Z}\int \textrm{d}^3 \vec{v} \, p(\vec{v}) = \frac{1}{Z} \left( \sqrt{\frac{2 \pi k T }{m}}\,\right)^3 \longrightarrow Z = \left(\frac{2 \pi k T }{m}\right)^{3/2},
$$
